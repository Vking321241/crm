...
// Brand typeface (DivaryTalk_Brand_Identity.pdf): ExtraBold for the
// "DIVARY" wordmark, Regular for "Talk" and headings generally.
// Loaded as a separate variable from Inter so body copy stays on
// Inter and only headings/the logotype opt into Plus Jakarta Sans.
...
export const metadata: Metadata = {
  title: {
    default: "DivaryTalk",
    template: "%s — DivaryTalk",
  },
  description: "CRM omnichannel para WhatsApp, hospedado na sua própria VPS.",
  robots: {
    index: false,
    follow: false,
  },
